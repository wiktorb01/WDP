...
/* posortowane po resztach mod q*/
/* Trzymamy zbior_ary jako zbior ciągów arytmetycznych*/
typedef struct zbior_ary {
  unsigned ary;
  unsigned moc;
  int *a; //tablica początków podciagów arytmetycznych
  int *b; //tablica końców podciagów arytmetycznych
} zbior_ary;
